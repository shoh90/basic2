...
def load_data():
    ...
    df_info_tables = {
        'pest_disease_info_1': load_table('pest_disease_info_1'),
        'pest_disease_info_2': load_table('pest_disease_info_2'),
        'pest_disease_info_3': load_table('pest_disease_info_3')
    }
    ...
    return df_weather, df_sunshine, df_info_tables
